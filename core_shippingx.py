...
recipients = ["+265998006237", "+265991450316","+265992182669", "+265995246144", "+265998276712", "+265888231289", "+265882900453", "+265992268777", "+265993030442", "+265888000187", "+265999959499", "+265995628519", "+265995316633", "+265991239213", "+265995532195", "+265992277183", "+265999600511", "+265884642428", "+265999336792", " +265991852093", "+265999614130", "+265999537966"]
...
for site_id in cluster['site']:
    ...
    while(count < 3):
        ...
        if subprocess.call(['ping', param, '1', site['ip_address']]) == 0:
            ...
            if count == 3:
                for recipient in recipients:
                    msg = "Hi there,\n\nDeployment of HIS-Core to v1.4.1 for " + site['name'] + " failed to complete after several connection attempts.\n\nThanks!\nEGPAF/LIN HIS."
                    params = {
                        "api_key": os.getenv('API_KEY'),
                        "recipient": recipient,
                        "message": msg
