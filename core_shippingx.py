...
recipients = ["+265998006237", "+265991312980", "+265995246144", "+265995971632", "+265999453942","+265997762346","+265888027458", "+265882680534","+265997174007","+265994666034", "+265996963312","+265996146325","+265992215557","+265999755473"]
    ...
    while(count < 3):
        ...
        if subprocess.call(['ping', param, '1', site['ip_address']]) == 0:
            ...
            for recipient in recipients:
                msg = "Hi there,\n\nDeployment of CORE to v5.0.4 for " + site['name'] + " completed succesfully.\n\nThanks!\nEGPAF HIS."
                params = {
            ...
            if count == 3:
                for recipient in recipients:
                    msg = "Hi there,\n\nDeployment of CORE to v5.0.4 for " + site['name'] + " failed to complete after several connection attempts.\n\nThanks!\nEGPAF HIS."
                    params = {
                        "api_key": os.getenv('API_KEY'),
                        "recipient": recipient,
                        "message": msg
